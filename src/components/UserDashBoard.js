                ...
                <table className="table table-hover">
                  <tbody>
                    {filteredGroups.map((group) => (
                      ...
                      >
                        <td>{group.name}</td>
                        <td>{group.type==="Technical" ?(<sup  className=" float-start my-1">Technical</sup>):(<sup className=" float-start my-1">Functional</sup>)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                  ...
                  >
                    ...
                    >
                      <div className="message-info d-flex justify-content-between align-items-center mb-1">
                        <span className="message-sender fw-bold">
                          {message.employee.id === employee.id
                            ? "You"
